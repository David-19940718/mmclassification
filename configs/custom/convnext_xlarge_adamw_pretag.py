...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_prefix='data/0308_train_standford_compcars_mini_bus_test_benchmarkv1',
        ann_file='data/0308_train_standford_compcars_mini_bus_test_benchmarkv1/meta/train.txt',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        data_prefix='data/0308_train_standford_compcars_mini_bus_test_benchmarkv1',
        ann_file='data/0308_train_standford_compcars_mini_bus_test_benchmarkv1/meta/val.txt',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        data_prefix='data/0308_train_standford_compcars_mini_bus_test_benchmarkv1',
        ann_file='data/0308_train_standford_compcars_mini_bus_test_benchmarkv1/meta/test.txt',
        pipeline=test_pipeline))
evaluation = dict(
    interval=5, 
