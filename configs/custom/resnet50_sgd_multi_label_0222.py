...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_prefix='data/0221_standford_multi_label_dataset',
        ann_file='data/0221_standford_multi_label_dataset/meta/train.txt',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        data_prefix='data/0221_standford_multi_label_dataset',
        ann_file='data/0221_standford_multi_label_dataset/meta/val.txt',
