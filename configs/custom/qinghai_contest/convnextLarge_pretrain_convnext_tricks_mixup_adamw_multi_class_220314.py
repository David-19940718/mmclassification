...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=[
            ...
            dict(
                type='Pretrained',
                checkpoint='weights/convnext-large_in21k-pre-3rdparty_64xb64_in1k_20220124-2412403d.pth',
                prefix='backbone',
            )
        ]
    ),
...
work_dir = '/home/jack/Projects/openmmlab/mmclassification/work_dirs/train/qinghai_contest/convnextLarge_pretrain_convnext_tricks_mixup_adamw_multi_class_220314'
